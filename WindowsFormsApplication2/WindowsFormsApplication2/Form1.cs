            ...
            try
            {
                if (rad_PBH.Checked == true)
                {
                    ...
                    if (comboBox2.Text == "sin")
                    {
                        ...
                        MessageBox.Show("The sin is " + output.ToString());
                    }
                    if (comboBox2.Text == "cos")
                    {
                        output = Base / Hypo;
                        MessageBox.Show("The Cos is  " + output.ToString());
                    }
                    if (comboBox2.Text == "tan")
                    {
                        output = perpendicular / Hypo;
                        MessageBox.Show("The Tan  is  " + output.ToString());
                    }
                    if (comboBox2.Text == "sec")
                    {
                        output = Hypo / Base;
                        MessageBox.Show("The Sec is  " + output.ToString());
                    }
                    if (comboBox2.Text == "cosec")
                    {
                        output = Hypo / Base;
                        MessageBox.Show("The Cosec is  " + output.ToString());
                    }
                    if (comboBox2.Text == "cot")
                    {
                        output = Base / Hypo;
                        MessageBox.Show("The Cot  is  " + output.ToString());
                    }
                }
                ...
                else if (rad_theta.Checked == true)
                {
                    ...
                    if (comboBox2.Text == "sin")
                    {
                        ...
                        MessageBox.Show("Value of sin is  " + Math.Sin(radians).ToString() + " ° ");
                    }
                    else if (comboBox2.Text == "cos")
                    {
                        a = Math.Abs(a);
                        double radians = a * (Math.PI / 180);
                        MessageBox.Show("Value of Cos is  " + Math.Cos(radians).ToString() + " ° ");
                    }
                    else if (comboBox2.Text == "tan")
                    {
                        a = Math.Abs(a);
                        double radians = a * (Math.PI / 180);
                        MessageBox.Show("Value of Tan is  " + Math.Tan(radians).ToString() + " ° ");
                    }
                    else if (comboBox2.Text == "cosec")
                    {
                        a = Math.Abs(a);
                        double radians = a * (Math.PI / 180);
                        MessageBox.Show("Value of Cosec is  " + (1 / Math.Cos(radians)).ToString() + " ° ");
                    }
                    else if (comboBox2.Text == "sec")
                    {
                        a = Math.Abs(a);
                        double radians = a * (Math.PI / 180);
                        MessageBox.Show("Value of Sec is  " + (1 / Math.Sin(radians)).ToString() + " ° ");
                    }
                    else if (comboBox2.Text == "cot")
                    {
                        a = Math.Abs(a);
                        double radians = a * (Math.PI / 180);
                        MessageBox.Show("Value of Cot is  " + (1 / Math.Tan(radians)).ToString() + " ° ");
                    }
                }
            ...
            try
            {
                ...
                else if (comboBox3.Text == "angle")
                {
                    if (txt_Hyp.Text == "")
                    {
                        ...
                        MessageBox.Show("The Measured angle  is  " + result.ToString() + " ° ");
                ...
                else if (comboBox3.Text == "length")
                {
                    ...
                    angle_value = Math.Abs(angle_value);
                    result = p / (angle_value);
                    MessageBox.Show("The Measured Length is  " + result.ToString() + " m ");
                ...
                else if (comboBox3.Text == "multiple angles")
                {
                    ...
                    if (combo_MultiAngles_options.Text == "distance")
                    {
                        if (rad_Cdistance.Checked == true)
                        {
                            ...
                            result = tb - rb;
                            result = Math.Abs(result);
                            MessageBox.Show("The  Covered distance is  " + result.ToString() + " m ");
                        }
                        else if (Rad_Rdistance.Checked == true)
                        {
                            ...
                            MessageBox.Show("The remaining distance is  " + rb.ToString() + " m ");
                        }
                    ...
                    else if (combo_MultiAngles_options.Text == "heigth")
                    {
                        if (rad_covered_height.Checked == true)
                        {
                            ...
                            result = ch - rh;
                            result = Math.Abs(result);
                            MessageBox.Show("The Covered Height is  " + result.ToString() + " m ");
                        ...
                        else if (rad_remaining_height.Checked == true)
                        {
                            ...
                            angle = Convert.ToInt16(txt_Angle.Text);
                            angle2 = Convert.ToInt32(txt_angle2.Text);
                            angle2 = int.Parse((angle2 * (3.14 / 180)).ToString());
                            angle_value = Math.Tan(angle2);
                            angle_value = Math.Abs(angle_value);
                            rh = angle_value * ba;
                            rh = Math.Abs(rh);
                            MessageBox.Show("The Remaining Height is  " + rh.ToString()+" m ");
                        }
                    }
                    else if (combo_MultiAngles_options.Text == "angle")
                    {
                        if (rd_first_angle.Checked == true)
                        {
                            ...
                            result = 1 / (Math.Tan(result));
                            result = Math.Abs(result);
                            MessageBox.Show("The First Angle is  " + result.ToString() + " ° ");
                        }
                        else if (rd_second_angle.Checked == true)
                        {
                            ...
                            result = Math.Abs(result);
                            MessageBox.Show("The Second Angle is  " + result.ToString() + " ° ");
